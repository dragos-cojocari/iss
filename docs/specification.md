...
- **Rental Limit**: Users can rent a maximum of 3 books at any given time
- **Availability Check**: Books can only be rented if they are currently available (not rented by another user)
